...
public class MainActivity extends AppCompatActivity {
    ...
    // DOE (30) Return 0 if mWeatherData is null, or the size of mWeatherData if it is not null
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.recylcerview_forecat);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(this,
                LinearLayoutManager.VERTICAL, shouldReverseLayout);
